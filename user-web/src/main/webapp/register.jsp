...
<div class="container">
    <form class="form-register" method="post" action="register">
        ...
        <label for="inputEmail" class="sr-only">请输入电子邮件</label> <input
            ...
            <label for="inputPhoneNumber" class="sr-only">Phone</label><input
            type="number" id="inputPhoneNumber" class="form-control" name="phone"
            placeholder="请输入手机号" required>
        <label for="inputName" class="sr-only">Phone</label><input

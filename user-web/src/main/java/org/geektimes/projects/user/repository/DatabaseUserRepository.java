...
//        Connection connection = DriverManager.getConnection("jdbc:derby:/Databases/UserPlatformDB;create=true");
//        return dbConnectionManager.getConnectionByHand();
//        return connection;
    }
    ...
    public boolean save(User user) {
        StringBuffer sb = new StringBuffer(INSERT_USER_DML_SQL);
        String userInfo = "'"+user.getName()+ "'"+","+ "'"+user.getPassword()+ "'"+","+ "'"+user.getEmail()+ "'"+","+ "'"+user.getPhoneNumber()+ "'";
        sb.replace(sb.length()-8,sb.length()-1,userInfo);
